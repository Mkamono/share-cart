...
func decodeMarketMarketIdDeleteResponse(resp *http.Response) (res *MarketMarketIdDeleteNoContent, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &MarketMarketIdDeleteNoContent{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *R500InternalServerErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeMarketMarketIdGetResponse(resp *http.Response) (res *Market, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeMarketPostResponse(resp *http.Response) (res *Market, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
