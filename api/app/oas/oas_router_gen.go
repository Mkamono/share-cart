		...
		case '/': // Prefix: "/"
			...
			case 'm': // Prefix: "market"
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "DELETE":
							s.handleMarketMarketIdDeleteRequest([1]string{
								args[0],
							}, elemIsEscaped, w, r)
						case "GET":
							s.handleMarketMarketIdGetRequest([1]string{
								args[0],
							}, elemIsEscaped, w, r)
						default:
			...
			case 't': // Prefix: "test"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleTestGetRequest([0]string{}, elemIsEscaped, w, r)
					default:
			...
			case 'm': // Prefix: "market"
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "DELETE":
							r.name = "MarketMarketIdDelete"
							r.summary = "Delete a market by ID"
							r.operationID = ""
							r.pathPattern = "/market/{marketId}"
							r.args = args
							r.count = 1
							return r, true
						case "GET":
							r.name = "MarketMarketIdGet"
							r.summary = "Get a market by ID"
							r.operationID = ""
							r.pathPattern = "/market/{marketId}"
							r.args = args
							r.count = 1
